  ...
  def render_index(resources, target: nil)
    ...
    respond_to do |format|
      format.html do
        ...
        render component_class.new(resources, context_params: context_params, scope: resource_class.to_s.underscore)
      end
      format.turbo_stream do
        component_class = namespaced_class('namespace', resource_class.name, "ResourcesComponent")
        render turbo_stream: turbo_stream.replace(target, component_class.new(resources, context_params: context_params, scope: resource_class.to_s.underscore))
      end
    end
  end
  ...
  def show
    ...
    respond_to do |format|
      format.html do
        ...
        render component.new(@resource, context_params: context_params, scope: resource_class.to_s.underscore)
      end
      format.turbo_stream do
